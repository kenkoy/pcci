package com.pcci.idls.maintenance.account.domain;
...
public class Account {
    ...
    public Account(String acctCode, String acctDesc, String acctNormalBalance,
			String acctReptName, String ifmsBasedId, String ifmsBasedName,
